awsim['route53'] = {
  ...
  "operations":{
    ...
    "DeleteQueryLoggingConfig":{
      ...
      "documentation":"<p>Deletes a configuration for DNS query logging. If you delete a configuration, Amazon Route 53 stops sending query logs to CloudWatch Logs. Amazon Route 53 doesn't delete any logs that are already in CloudWatch Logs.</p> <p>For more information about DNS query logs, see <a>CreateQueryLoggingConfig</a>.</p>"
    },
    ...
    "DeleteTrafficPolicyInstance":{
      ...
      "documentation":"<p>Deletes a traffic policy instance and all of the resource record sets that Amazon Route 53 created when you created the instance.</p> <note> <p>In the Amazon Route 53 console, traffic policy instances are known as policy records.</p> </note>"
    },
    ...
    "DisassociateVPCFromHostedZone":{
      ...
      "documentation":"<p>Disassociates a VPC from a Amazon Route 53 private hosted zone. </p> <note> <p>You can't disassociate the last VPC from a private hosted zone.</p> </note> <important> <p>You can't disassociate a VPC from a private hosted zone when only one VPC is associated with the hosted zone. You also can't convert a private hosted zone into a public hosted zone.</p> </important>"
    },
    "GetAccountLimit":{
    ...
    "GetCheckerIpRanges":{
      ...
      "documentation":"<p> <code>GetCheckerIpRanges</code> still works, but we recommend that you download ip-ranges.json, which includes IP address ranges for all AWS services. For more information, see <a href=\"http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/route-53-ip-addresses.html\">IP Address Ranges of Amazon Route 53 Servers</a> in the <i>Amazon Route 53 Developer Guide</i>.</p>"
    },
    "GetGeoLocation":{
      "name":"GetGeoLocation",
      "http":{
    ...
    "GetQueryLoggingConfig":{
      ...
      "documentation":"<p>Gets information about a specified configuration for DNS query logging.</p> <p>For more information about DNS query logs, see <a>CreateQueryLoggingConfig</a> and <a href=\"http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/query-logs.html\">Logging DNS Queries</a>.</p>"
    },
    ...
    "GetReusableDelegationSetLimit":{
      ...
      "documentation":"<p>Gets the maximum number of hosted zones that you can associate with the specified reusable delegation set.</p> <p>For the default limit, see <a href=\"http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DNSLimitations.html\">Limits</a> in the <i>Amazon Route 53 Developer Guide</i>. To request a higher limit, <a href=\"https://console.aws.amazon.com/support/home#/case/create?issueType=service-limit-increase&amp;limitType=service-code-route53\">open a case</a>.</p>"
    },
    "GetTrafficPolicy":{
    ...
    "ListTrafficPolicies":{
      ...
      "documentation":"<p>Gets information about the latest version for every traffic policy that is associated with the current AWS account. Policies are listed in the order in which they were created. </p>"
    },
  ...
  "shapes":{
    "AccountLimit":{
      ...
      "members":{
        ...
        "Value":{
          "shape":"LimitValue",
          "documentation":"<p>The current value for the limit that is specified by <a>AccountLimit$Type</a>.</p>"
        }
      },
    ...
    "CreateHostedZoneRequest":{
      ...
      "members":{
        ...
        "DelegationSetId":{
          "shape":"ResourceId",
          "documentation":"<p>If you want to associate a reusable delegation set with this hosted zone, the ID that Amazon Route 53 assigned to the reusable delegation set when you created it. For more information about reusable delegation sets, see <a>CreateReusableDelegationSet</a>.</p>"
        }
      },
    ...
    "CreateTrafficPolicyRequest":{
      ...
      "members":{
        ...
        "Document":{
          ...
          "documentation":"<p>The definition of this traffic policy in JSON format. For more information, see <a href=\"http://docs.aws.amazon.com/Route53/latest/APIReference/api-policies-traffic-policy-document-format.html\">Traffic Policy Document Format</a>.</p>"
        },
        "Comment":{
    ...
    "GetQueryLoggingConfigResponse":{
      ...
      "members":{
        "QueryLoggingConfig":{
          "shape":"QueryLoggingConfig",
          "documentation":"<p>A complex type that contains information about the query logging configuration that you specified in a <a>GetQueryLoggingConfig</a> request.</p>"
        }
      }
    },
    ...
    "HealthCheckConfig":{
      ...
      "members":{
        ...
        "Port":{
          "shape":"Port",
          "documentation":"<p>The port on the endpoint on which you want Amazon Route 53 to perform health checks. Specify a value for <code>Port</code> only when you specify a value for <code>IPAddress</code>.</p>"
        },
        "Type":{
        ...
        "InsufficientDataHealthStatus":{
          ...
          "documentation":"<p>When CloudWatch has insufficient data about the metric to determine the alarm state, the status that you want Amazon Route 53 to assign to the health check:</p> <ul> <li> <p> <code>Healthy</code>: Amazon Route 53 considers the health check to be healthy.</p> </li> <li> <p> <code>Unhealthy</code>: Amazon Route 53 considers the health check to be unhealthy.</p> </li> <li> <p> <code>LastKnownStatus</code>: Amazon Route 53 uses the status of the health check from the last time that CloudWatch had sufficient data to determine the alarm state. For new health checks that have no last known status, the default status for the health check is healthy.</p> </li> </ul>"
        }
      },
    ...
    "HostedZone":{
      ...
      "members":{
        ...
        "LinkedService":{
          "shape":"LinkedService",
          "documentation":"<p>If the hosted zone was created by another service, the service that created the hosted zone. When a hosted zone is created by another service, you can't edit or delete it using Amazon Route 53. </p>"
        }
      },
      "documentation":"<p>A complex type that contains general information about the hosted zone.</p>"
    },
    ...
    "LimitsExceeded":{
      ...
      "documentation":"<p>This operation can't be completed either because the current account has reached the limit on reusable delegation sets that it can create or because you've reached the limit on the number of Amazon VPCs that you can associate with a private hosted zone. To get the current limit on the number of reusable delegation sets, see <a>GetAccountLimit</a>. To get the current limit on the number of Amazon VPCs that you can associate with a private hosted zone, see <a>GetHostedZoneLimit</a>. To request a higher limit, <a href=\"http://aws.amazon.com/route53-request\">create a case</a> with the AWS Support Center.</p>",
      "exception":true
    },
    "LinkedService":{
      "type":"structure",
    ...
    "ListQueryLoggingConfigsRequest":{
      ...
      "members":{
        ...
        "MaxResults":{
          "shape":"MaxResults",
          "documentation":"<p>(Optional) The maximum number of query logging configurations that you want Amazon Route 53 to return in response to the current request. If the current AWS account has more than <code>MaxResults</code> configurations, use the value of <a>ListQueryLoggingConfigsResponse$NextToken</a> in the response to get the next page of results.</p> <p>If you don't specify a value for <code>MaxResults</code>, Amazon Route 53 returns up to 100 configurations.</p>",
          "location":"querystring",
    ...
    "ListQueryLoggingConfigsResponse":{
      ...
      "members":{
        "QueryLoggingConfigs":{
          ...
          "documentation":"<p>An array that contains one <a>QueryLoggingConfig</a> element for each configuration for DNS query logging that is associated with the current AWS account.</p>"
        },
        "NextToken":{
          "shape":"PaginationToken",
    ...
    "ListResourceRecordSetsRequest":{
      ...
      "members":{
        ...
        "StartRecordName":{
          "shape":"DNSName",
          "documentation":"<p>The first name in the lexicographic ordering of resource record sets that you want to list.</p>",
          "location":"querystring",
          "locationName":"name"
        },
        "StartRecordType":{
    ...
    "ListReusableDelegationSetsRequest":{
      ...
      "members":{
        ...
        "MaxItems":{
          "shape":"PageMaxItems",
          "documentation":"<p>The number of reusable delegation sets that you want Amazon Route 53 to return in the response to this request. If you specify a value greater than 100, Amazon Route 53 returns only the first 100 reusable delegation sets.</p>",
          "location":"querystring",
          "locationName":"maxitems"
        }
      },
    ...
    "ListTrafficPolicyInstancesResponse":{
      ...
      "members":{
        ...
        "HostedZoneIdMarker":{
          "shape":"ResourceId",
          "documentation":"<p>If <code>IsTruncated</code> is <code>true</code>, <code>HostedZoneIdMarker</code> is the ID of the hosted zone of the first traffic policy instance that Amazon Route 53 will return if you submit another <code>ListTrafficPolicyInstances</code> request. </p>"
        },
        "TrafficPolicyInstanceNameMarker":{
          "shape":"DNSName",
          "documentation":"<p>If <code>IsTruncated</code> is <code>true</code>, <code>TrafficPolicyInstanceNameMarker</code> is the name of the first traffic policy instance that Amazon Route 53 will return if you submit another <code>ListTrafficPolicyInstances</code> request. </p>"
        },
        "TrafficPolicyInstanceTypeMarker":{
          "shape":"RRType",
    ...
    "ListTrafficPolicyVersionsRequest":{
      ...
      "members":{
        ...
        "MaxItems":{
          "shape":"PageMaxItems",
          "documentation":"<p>The maximum number of traffic policy versions that you want Amazon Route 53 to include in the response body for this request. If the specified traffic policy has more than <code>MaxItems</code> versions, the value of <code>IsTruncated</code> in the response is <code>true</code>, and the value of the <code>TrafficPolicyVersionMarker</code> element is the ID of the first version that Amazon Route 53 will return if you submit another request.</p>",
          "location":"querystring",
          "locationName":"maxitems"
        }
      },
    ...
    "ListVPCAssociationAuthorizationsRequest":{
      ...
      "members":{
        ...
        "MaxResults":{
          "shape":"MaxResults",
          "documentation":"<p> <i>Optional</i>: An integer that specifies the maximum number of VPCs that you want Amazon Route 53 to return. If you don't specify a value for <code>MaxResults</code>, Amazon Route 53 returns up to 50 VPCs per page.</p>",
          "location":"querystring",
          "locationName":"maxresults"
        }
      },
    ...
    "ResourceRecordSet":{
      ...
      "members":{
        ...
        "Region":{
          ...
          "documentation":"<p> <i>Latency-based resource record sets only:</i> The Amazon EC2 Region where you created the resource that this resource record set refers to. The resource typically is an AWS resource, such as an EC2 instance or an ELB load balancer, and is referred to by an IP address or a DNS domain name, depending on the record type.</p> <note> <p>Creating latency and latency alias resource record sets in private hosted zones is not supported.</p> </note> <p>When Amazon Route 53 receives a DNS query for a domain name and type for which you have created latency resource record sets, Amazon Route 53 selects the latency resource record set that has the lowest latency between the end user and the associated Amazon EC2 Region. Amazon Route 53 then returns the value that is associated with the selected resource record set.</p> <p>Note the following:</p> <ul> <li> <p>You can only specify one <code>ResourceRecord</code> per latency resource record set.</p> </li> <li> <p>You can only create one latency resource record set for each Amazon EC2 Region.</p> </li> <li> <p>You aren't required to create latency resource record sets for all Amazon EC2 Regions. Amazon Route 53 will choose the region with the best latency from among the regions that you create latency resource record sets for.</p> </li> <li> <p>You can't create non-latency resource record sets that have the same values for the <code>Name</code> and <code>Type</code> elements as latency resource record sets.</p> </li> </ul>"
        },
        "GeoLocation":{
          "shape":"GeoLocation",
    ...
    "TooManyTrafficPolicyVersionsForCurrentPolicy":{
      ...
      "documentation":"<p>This traffic policy version can't be created because you've reached the limit of 1000 on the number of versions that you can create for the current traffic policy.</p> <p>To create more traffic policy versions, you can use <a>GetTrafficPolicy</a> to get the traffic policy document for a specified traffic policy version, and then use <a>CreateTrafficPolicy</a> to create a new traffic policy using the traffic policy document.</p>",
      "error":{"httpStatusCode":400},
      "exception":true
    },
    ...
    "VPC":{
      ...
      "members":{
        "VPCRegion":{
          "shape":"VPCRegion",
          "documentation":"<p>(Private hosted zones only) The region in which you created an Amazon VPC.</p>"
        },
        "VPCId":{"shape":"VPCId"}
      },
