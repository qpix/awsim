awsim['glacier'] = {
  ...
  "operations":{
    ...
    "DeleteVaultAccessPolicy":{
      ...
      "documentation":"<p>This operation deletes the access policy associated with the specified vault. The operation is eventually consistent; that is, it might take some time for Amazon Glacier to completely remove the access policy, and you might still see the effect of the policy for a short time after you send the delete request.</p> <p>This operation is idempotent. You can invoke delete multiple times, even if there is no policy associated with the vault. For more information about vault access policies, see <a href=\"http://docs.aws.amazon.com/amazonglacier/latest/dev/vault-access-policy.html\">Amazon Glacier Access Control with Vault Access Policies</a>. </p>"
    },
    ...
    "ListTagsForVault":{
      ...
      "documentation":"<p>This operation lists all the tags attached to a vault. The operation returns an empty map if there are no tags. For more information about tags, see <a href=\"http://docs.aws.amazon.com/amazonglacier/latest/dev/tagging.html\">Tagging Amazon Glacier Resources</a>.</p>"
    },
    "ListVaults":{
      "name":"ListVaults",
      "http":{
  ...
  "shapes":{
    ...
    "DescribeVaultOutput":{
      ...
      "members":{
        ...
        "LastInventoryDate":{
          "shape":"string",
          "documentation":"<p>The Universal Coordinated Time (UTC) date when Amazon Glacier completed the last vault inventory. This value should be a string in the ISO 8601 date format, for example <code>2012-03-20T17:03:43.221Z</code>.</p>"
        },
        "NumberOfArchives":{
          "shape":"long",
    ...
    "GlacierJobDescription":{
      ...
      "documentation":"<p>Contains the description of an Amazon Glacier job.</p>"
    },
    "Grant":{
      "type":"structure",
      "members":{
    ...
    "InsufficientCapacityException":{
      ...
      "documentation":"<p>Returned if there is insufficient capacity to process this expedited request. This error only applies to expedited retrievals and not to standard or bulk retrievals.</p>",
    ...
    "LimitExceededException":{
      ...
      "members":{
        ...
        "message":{
          "shape":"string",
          "documentation":"<p>Returned if the request results in a vault limit or tags limit being exceeded.</p>"
        }
      },
    ...
    "ListProvisionedCapacityInput":{
      ...
      "members":{
        "accountId":{
          "shape":"string",
          "documentation":"<p>The AWS account ID of the account that owns the vault. You can either specify an AWS account ID or optionally a single '-' (hyphen), in which case Amazon Glacier uses the AWS account ID associated with the credentials used to sign the request. If you use an account ID, don't include any hyphens ('-') in the ID. </p>",
          "location":"uri",
          "locationName":"accountId"
        }
      }
    ...
    "MissingParameterValueException":{
      ...
      "members":{
        ...
        "message":{
          "shape":"string",
          "documentation":"<p>Returned if no authentication data is found for the request.</p>"
        }
      },
    ...
    "PolicyEnforcedException":{
      ...
      "members":{
        ...
        "code":{
          "shape":"string",
          "documentation":"<p>PolicyEnforcedException</p>"
        },
        "message":{
          "shape":"string",
          "documentation":"<p>InitiateJob request denied by current data retrieval policy.</p>"
        }
      },
    ...
    "ResourceNotFoundException":{
      ...
      "members":{
        ...
        "message":{
          "shape":"string",
          "documentation":"<p>Returned if the specified resource (such as a vault, upload ID, or job ID) doesn't exist.</p>"
        }
      },
      "documentation":"<p>Returned if the specified resource (such as a vault, upload ID, or job ID) doesn't exist.</p>",
