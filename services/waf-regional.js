awsim['waf-regional'] = {
  ...
  "operations":{
    ...
    "DeleteLoggingConfiguration":{
      ...
      "documentation":"<p>Permanently deletes the <a>LoggingConfiguration</a> from the specified web ACL.</p>"
    },
    ...
    "DeleteRegexPatternSet":{
      ...
      "documentation":"<p>Permanently deletes a <a>RegexPatternSet</a>. You can't delete a <code>RegexPatternSet</code> if it's still used in any <code>RegexMatchSet</code> or if the <code>RegexPatternSet</code> is not empty. </p>"
    },
    "DeleteRule":{
      "name":"DeleteRule",
      "http":{
    ...
    "DeleteRuleGroup":{
      ...
      "documentation":"<p>Permanently deletes a <a>RuleGroup</a>. You can't delete a <code>RuleGroup</code> if it's still used in any <code>WebACL</code> objects or if it still includes any rules.</p> <p>If you just want to remove a <code>RuleGroup</code> from a <code>WebACL</code>, use <a>UpdateWebACL</a>.</p> <p>To permanently delete a <code>RuleGroup</code> from AWS WAF, perform the following steps:</p> <ol> <li> <p>Update the <code>RuleGroup</code> to remove rules, if any. For more information, see <a>UpdateRuleGroup</a>.</p> </li> <li> <p>Use <a>GetChangeToken</a> to get the change token that you provide in the <code>ChangeToken</code> parameter of a <code>DeleteRuleGroup</code> request.</p> </li> <li> <p>Submit a <code>DeleteRuleGroup</code> request.</p> </li> </ol>"
    },
    ...
    "GetGeoMatchSet":{
      ...
      "documentation":"<p>Returns the <a>GeoMatchSet</a> that is specified by <code>GeoMatchSetId</code>.</p>"
    },
    "GetIPSet":{
      "name":"GetIPSet",
      "http":{
    ...
    "GetLoggingConfiguration":{
      ...
      "documentation":"<p>Returns the <a>LoggingConfiguration</a> for the specified web ACL.</p>"
    },
    "GetPermissionPolicy":{
    ...
    "GetRateBasedRule":{
      ...
      "documentation":"<p>Returns the <a>RateBasedRule</a> that is specified by the <code>RuleId</code> that you included in the <code>GetRateBasedRule</code> request.</p>"
    },
    ...
    "GetRegexMatchSet":{
      ...
      "documentation":"<p>Returns the <a>RegexMatchSet</a> specified by <code>RegexMatchSetId</code>.</p>"
    },
    "GetRegexPatternSet":{
      ...
      "documentation":"<p>Returns the <a>RegexPatternSet</a> specified by <code>RegexPatternSetId</code>.</p>"
    },
    "GetRule":{
      "name":"GetRule",
      "http":{
    ...
    "GetRuleGroup":{
      ...
      "documentation":"<p>Returns the <a>RuleGroup</a> that is specified by the <code>RuleGroupId</code> that you included in the <code>GetRuleGroup</code> request.</p> <p>To view the rules in a rule group, use <a>ListActivatedRulesInRuleGroup</a>.</p>"
    },
    "GetSampledRequests":{
    ...
    "GetWebACLForResource":{
      ...
      "documentation":"<p>Returns the web ACL for the specified resource.</p>"
    },
    "GetXssMatchSet":{
      "name":"GetXssMatchSet",
      "http":{
    ...
    "ListActivatedRulesInRuleGroup":{
      ...
      "documentation":"<p>Returns an array of <a>ActivatedRule</a> objects.</p>"
    },
    "ListByteMatchSets":{
    ...
    "ListGeoMatchSets":{
      ...
      "documentation":"<p>Returns an array of <a>GeoMatchSetSummary</a> objects in the response.</p>"
    },
    "ListIPSets":{
      "name":"ListIPSets",
      "http":{
    ...
    "ListLoggingConfigurations":{
      ...
      "documentation":"<p>Returns an array of <a>LoggingConfiguration</a> objects.</p>"
    },
    "ListRateBasedRules":{
    ...
    "ListRegexMatchSets":{
      ...
      "documentation":"<p>Returns an array of <a>RegexMatchSetSummary</a> objects.</p>"
    },
    "ListRegexPatternSets":{
      ...
      "documentation":"<p>Returns an array of <a>RegexPatternSetSummary</a> objects.</p>"
    },
    ...
    "ListRuleGroups":{
      ...
      "documentation":"<p>Returns an array of <a>RuleGroup</a> objects.</p>"
    },
    "ListRules":{
      "name":"ListRules",
      "http":{
    ...
    "ListSubscribedRuleGroups":{
      ...
      "documentation":"<p>Returns an array of <a>RuleGroup</a> objects that you are subscribed to.</p>"
    },
    "ListWebACLs":{
      "name":"ListWebACLs",
      "http":{
  ...
  "shapes":{
    ...
    "CreateRateBasedRuleRequest":{
      ...
      "members":{
        ...
        "MetricName":{
          "shape":"MetricName",
          "documentation":"<p>A friendly name or description for the metrics for this <code>RateBasedRule</code>. The name can contain only alphanumeric characters (A-Z, a-z, 0-9); the name can't contain whitespace. You can't change the name of the metric after you create the <code>RateBasedRule</code>.</p>"
        },
        "RateKey":{
          "shape":"RateKey",
    ...
    "CreateRuleGroupRequest":{
      ...
      "members":{
        ...
        "MetricName":{
          "shape":"MetricName",
          "documentation":"<p>A friendly name or description for the metrics for this <code>RuleGroup</code>. The name can contain only alphanumeric characters (A-Z, a-z, 0-9); the name can't contain whitespace. You can't change the name of the metric after you create the <code>RuleGroup</code>.</p>"
        },
        "ChangeToken":{
          "shape":"ChangeToken",
          "documentation":"<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "GeoMatchSet":{
      ...
      "documentation":"<p>Contains one or more countries that AWS WAF will search for.</p>"
    },
    ...
    "GeoMatchSetSummary":{
      ...
      "documentation":"<p>Contains the identifier and the name of the <code>GeoMatchSet</code>.</p>"
    },
    "GeoMatchSetUpdate":{
      "type":"structure",
      "required":[
      ...
      "documentation":"<p>Specifies the type of update to perform to an <a>GeoMatchSet</a> with <a>UpdateGeoMatchSet</a>.</p>"
    },
    "GeoMatchSetUpdates":{
      "type":"list",
    ...
    "RateBasedRule":{
      ...
      "members":{
        ...
        "MetricName":{
          "shape":"MetricName",
          "documentation":"<p>A friendly name or description for the metrics for a <code>RateBasedRule</code>. The name can contain only alphanumeric characters (A-Z, a-z, 0-9); the name can't contain whitespace. You can't change the name of the metric after you create the <code>RateBasedRule</code>.</p>"
        },
        "MatchPredicates":{
          "shape":"Predicates",
    ...
    "RegexMatchSet":{
      ...
      "documentation":"<p>In a <a>GetRegexMatchSet</a> request, <code>RegexMatchSet</code> is a complex type that contains the <code>RegexMatchSetId</code> and <code>Name</code> of a <code>RegexMatchSet</code>, and the values that you specified when you updated the <code>RegexMatchSet</code>.</p> <p> The values are contained in a <code>RegexMatchTuple</code> object, which specify the parts of web requests that you want AWS WAF to inspect and the values that you want AWS WAF to search for. If a <code>RegexMatchSet</code> contains more than one <code>RegexMatchTuple</code> object, a request needs to match the settings in only one <code>ByteMatchTuple</code> to be considered a match.</p>"
    },
    ...
    "RegexMatchSetSummary":{
      ...
      "documentation":"<p>Returned by <a>ListRegexMatchSets</a>. Each <code>RegexMatchSetSummary</code> object includes the <code>Name</code> and <code>RegexMatchSetId</code> for one <a>RegexMatchSet</a>.</p>"
    },
    "RegexMatchSetUpdate":{
      "type":"structure",
      "required":[
      ...
      "documentation":"<p>In an <a>UpdateRegexMatchSet</a> request, <code>RegexMatchSetUpdate</code> specifies whether to insert or delete a <a>RegexMatchTuple</a> and includes the settings for the <code>RegexMatchTuple</code>.</p>"
    },
    ...
    "RegexMatchTuple":{
      ...
      "documentation":"<p>The regular expression pattern that you want AWS WAF to search for in web requests, the location in requests that you want AWS WAF to search, and other settings. Each <code>RegexMatchTuple</code> object contains: </p> <ul> <li> <p>The part of a web request that you want AWS WAF to inspect, such as a query string or the value of the <code>User-Agent</code> header. </p> </li> <li> <p>The identifier of the pattern (a regular expression) that you want AWS WAF to look for. For more information, see <a>RegexPatternSet</a>. </p> </li> <li> <p>Whether to perform any conversions on the request, such as converting it to lowercase, before inspecting it for the specified string.</p> </li> </ul>"
    },
    "RegexMatchTuples":{
      "type":"list",
    ...
    "RegexPatternSet":{
      ...
      "documentation":"<p>The <code>RegexPatternSet</code> specifies the regular expression (regex) pattern that you want AWS WAF to search for, such as <code>B[a@]dB[o0]t</code>. You can then configure AWS WAF to reject those requests.</p>"
    },
    ...
    "RegexPatternSetSummary":{
      ...
      "documentation":"<p>Returned by <a>ListRegexPatternSets</a>. Each <code>RegexPatternSetSummary</code> object includes the <code>Name</code> and <code>RegexPatternSetId</code> for one <a>RegexPatternSet</a>.</p>"
    },
    "RegexPatternSetUpdate":{
      ...
      "documentation":"<p>In an <a>UpdateRegexPatternSet</a> request, <code>RegexPatternSetUpdate</code> specifies whether to insert or delete a <code>RegexPatternString</code> and includes the settings for the <code>RegexPatternString</code>.</p>"
    },
    ...
    "Rule":{
      ...
      "members":{
        ...
        "MetricName":{
          "shape":"MetricName",
          "documentation":"<p>A friendly name or description for the metrics for this <code>Rule</code>. The name can contain only alphanumeric characters (A-Z, a-z, 0-9); the name can't contain whitespace. You can't change <code>MetricName</code> after you create the <code>Rule</code>.</p>"
        },
        "Predicates":{
          "shape":"Predicates",
    ...
    "RuleGroup":{
      ...
      "documentation":"<p>A collection of predefined rules that you can add to a web ACL.</p> <p>Rule groups are subject to the following limits:</p> <ul> <li> <p>Three rule groups per account. You can request an increase to this limit by contacting customer support.</p> </li> <li> <p>One rule group per web ACL.</p> </li> <li> <p>Ten rules per rule group.</p> </li> </ul>"
    },
    "RuleGroupSummaries":{
      "type":"list",
    ...
    "RuleGroupSummary":{
      ...
      "documentation":"<p>Contains the identifier and the friendly name or description of the <code>RuleGroup</code>.</p>"
    },
    "RuleGroupUpdate":{
      "type":"structure",
      "required":[
      ...
      "documentation":"<p>Specifies an <code>ActivatedRule</code> and indicates whether you want to add it to a <code>RuleGroup</code> or delete it from a <code>RuleGroup</code>.</p>"
    },
    "RuleGroupUpdates":{
      "type":"list",
    ...
    "SubscribedRuleGroupSummary":{
      ...
      "documentation":"<p>A summary of the rule groups you are subscribed to.</p>"
    },
    "TextTransformation":{
      "type":"string",
      "enum":[
    ...
    "WafOverrideAction":{
      ...
      "documentation":"<p>The action to take if any rule within the <code>RuleGroup</code> matches a request. </p>"
    },
