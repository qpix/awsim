awsim['emr'] = {
  ...
  "operations":{
    ...
    "ListSteps":{
      ...
      "documentation":"<p>Provides a list of steps for the cluster in reverse order unless you specify stepIds with the request.</p>"
    },
    "ModifyInstanceFleet":{
  ...
  "shapes":{
    ...
    "Cluster":{
      ...
      "members":{
        ...
        "KerberosAttributes":{
          ...
          "documentation":"<p>Attributes for Kerberos configuration when Kerberos authentication is enabled using a security configuration. For more information see <a href=\"http://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-kerberos.html\">Use Kerberos Authentication</a> in the <i>EMR Management Guide</i>.</p>"
        }
      },
    ...
    "CreateSecurityConfigurationInput":{
      ...
      "members":{
        ...
        "SecurityConfiguration":{
          "shape":"String",
          "documentation":"<p>The security configuration details in JSON format. For JSON parameters and examples, see <a href=\"http://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-security-configurations.html\">Use Security Configurations to Set Up Cluster Security</a> in the <i>Amazon EMR Management Guide</i>.</p>"
        }
      }
    },
    ...
    "ListStepsInput":{
      ...
      "members":{
        ...
        "StepIds":{
          "shape":"XmlStringList",
          "documentation":"<p>The filter to limit the step list based on the identifier of the steps.</p>"
        },
        "Marker":{
          "shape":"Marker",
          "documentation":"<p>The pagination token that indicates the next set of results to retrieve.</p>"
    ...
    "Tag":{
      ...
      "members":{
        "Key":{
          "shape":"String",
          "documentation":"<p>A user-defined key, which is the minimum required information for a valid tag. For more information, see <a href=\"http://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-plan-tags.html\">Tag </a>. </p>"
        },
        "Value":{
          "shape":"String",
          "documentation":"<p>A user-defined value, which is optional in a tag. For more information, see <a href=\"http://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-plan-tags.html\">Tag Clusters</a>. </p>"
        }
      },
