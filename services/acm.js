awsim['acm'] = {
  ...
  "operations":{
    ...
    "ListCertificates":{
      ...
      "documentation":"<p>Retrieves a list of certificate ARNs and domain names. You can request that only certificates that match a specific status be listed. You can also filter by specific attributes of the certificate. </p>"
    },
  ...
  "shapes":{
    ...
    "CertificateDetail":{
      ...
      "members":{
        ...
        "RenewalEligibility":{
          ...
          "documentation":"<p>Specifies whether the certificate is eligible for renewal.</p>"
        },
        "Options":{
    ...
    "DomainValidation":{
      ...
      "members":{
        ...
        "ResourceRecord":{
          ...
          "documentation":"<p>Contains the CNAME record that you add to your DNS database for domain validation. For more information, see <a href=\"http://docs.aws.amazon.com/acm/latest/userguide/gs-acm-validate-dns.html\">Use DNS to Validate Domain Ownership</a>.</p>"
        },
        "ValidationMethod":{
    ...
    "ExportCertificateResponse":{
      ...
      "members":{
        ...
        "PrivateKey":{
          "shape":"PrivateKey",
          "documentation":"<p>The PEM-encoded private key associated with the public key in the certificate.</p>"
        }
      }
    },
    "ExtendedKeyUsage":{
    ...
    "Filters":{
      ...
      "members":{
        ...
        "keyTypes":{
          ...
          "documentation":"<p>Specify one or more algorithms that can be used to generate key pairs.</p>"
        }
      },
    ...
    "InvalidStateException":{
      ...
      "documentation":"<p>Processing has reached an invalid state.</p>",
      "exception":true
    },
    "InvalidTagException":{
      "type":"structure",
