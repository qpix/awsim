awsim['resourcegroupstaggingapi'] = {
  "version":"2.0",
  "metadata":{
    ...
    "GetResourcesInput":{
      ...
      "members":{
        ...
        "ResourcesPerPage":{
          ...
          "documentation":"<p>A limit that restricts the number of resources returned by GetResources in paginated output. You can set ResourcesPerPage to a minimum of 1 item and the maximum of 50 items. </p>"
        },
        "TagsPerPage":{
          "shape":"TagsPerPage",
