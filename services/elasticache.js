  ...
  "shapes":{
    ...
    "AddTagsToResourceMessage":{
      ...
      "members":{
        "ResourceName":{
          "shape":"String",
          "documentation":"<p>The Amazon Resource Name (ARN) of the resource to which the tags are to be added, for example <code>arn:aws:elasticache:us-west-2:0123456789:cluster:myCluster</code> or <code>arn:aws:elasticache:us-west-2:0123456789:snapshot:mySnapshot</code>. ElastiCache resources are <i>cluster</i> and <i>snapshot</i>.</p> <p>For more information about ARNs, see <a href=\"http://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html\">Amazon Resource Names (ARNs) and AWS Service Namespaces</a>.</p>"
        },
        "Tags":{
          "shape":"TagList",
    ...
    "CacheEngineVersion":{
      ...
      "members":{
        ...
        "CacheParameterGroupFamily":{
          "shape":"String",
          "documentation":"<p>The name of the cache parameter group family associated with this cache engine.</p> <p>Valid values are: <code>memcached1.4</code> | <code>redis2.6</code> | <code>redis2.8</code> | <code>redis3.2</code> | <code>redis4.0</code> </p>"
        },
    ...
    "CacheParameterGroup":{
      ...
      "members":{
        ...
        "CacheParameterGroupFamily":{
          "shape":"String",
          "documentation":"<p>The name of the cache parameter group family that this cache parameter group is compatible with.</p> <p>Valid values are: <code>memcached1.4</code> | <code>redis2.6</code> | <code>redis2.8</code> | <code>redis3.2</code> | <code>redis4.0</code> </p>"
        },
        "Description":{
          "shape":"String",
    ...
    "CreateCacheParameterGroupMessage":{
      ...
      "members":{
        ...
        "CacheParameterGroupFamily":{
          "shape":"String",
          "documentation":"<p>The name of the cache parameter group family that the cache parameter group can be used with.</p> <p>Valid values are: <code>memcached1.4</code> | <code>redis2.6</code> | <code>redis2.8</code> | <code>redis3.2</code> | <code>redis4.0</code> </p>"
        },
        "Description":{
          "shape":"String",
    ...
    "CreateReplicationGroupMessage":{
      ...
      "members":{
        ...
        "Tags":{
          "shape":"TagList",
          "documentation":"<p>A list of cost allocation tags to be added to this resource. A tag is a key-value pair.</p>"
        },
        "SnapshotArns":{
          "shape":"SnapshotArnsList",
    ...
    "DecreaseReplicaCountMessage":{
      ...
      "members":{
        ...
        "ApplyImmediately":{
          "shape":"Boolean",
          "documentation":"<p>If <code>True</code>, the number of replica nodes is decreased immediately. If <code>False</code>, the number of replica nodes is decreased during the next maintenance window.</p>"
        }
      }
    },
    ...
    "DescribeEngineDefaultParametersMessage":{
      ...
      "members":{
        "CacheParameterGroupFamily":{
          "shape":"String",
          "documentation":"<p>The name of the cache parameter group family.</p> <p>Valid values are: <code>memcached1.4</code> | <code>redis2.6</code> | <code>redis2.8</code> | <code>redis3.2</code> | <code>redis4.0</code> </p>"
        },
        "MaxRecords":{
          "shape":"IntegerOptional",
          "documentation":"<p>The maximum number of records to include in the response. If more records exist than the specified <code>MaxRecords</code> value, a marker is included in the response so that the remaining results can be retrieved.</p> <p>Default: 100</p> <p>Constraints: minimum 20; maximum 100.</p>"
    ...
    "EngineDefaults":{
      ...
      "members":{
        "CacheParameterGroupFamily":{
          "shape":"String",
          "documentation":"<p>Specifies the name of the cache parameter group family to which the engine default parameters apply.</p> <p>Valid values are: <code>memcached1.4</code> | <code>redis2.6</code> | <code>redis2.8</code> | <code>redis3.2</code> | <code>redis4.0</code> </p>"
        },
        "Marker":{
          "shape":"String",
          "documentation":"<p>Provides an identifier to allow retrieval of paginated results.</p>"
    ...
    "IncreaseReplicaCountMessage":{
      ...
      "members":{
        ...
        "ApplyImmediately":{
          "shape":"Boolean",
          "documentation":"<p>If <code>True</code>, the number of replica nodes is increased immediately. If <code>False</code>, the number of replica nodes is increased during the next maintenance window.</p>"
        }
      }
    },
    ...
    "ModifyReplicationGroupShardConfigurationMessage":{
      ...
      "members":{
        ...
        "NodeGroupsToRemove":{
          ...
          "documentation":"<p>If the value of <code>NodeGroupCount</code> is less than the current number of node groups (shards), the <code>NodeGroupsToRemove</code> or <code>NodeGroupsToRetain</code> is a required list of node group ids to remove from or retain in the cluster.</p> <p>ElastiCache for Redis will attempt to remove all node groups listed by <code>NodeGroupsToRemove</code> from the cluster.</p>"
        },
        "NodeGroupsToRetain":{
    ...
    "NodeGroupConfiguration":{
      ...
      "members":{
        "NodeGroupId":{
          "shape":"AllowedNodeGroupId",
          "documentation":"<p>The 4-digit id for the node group these configuration values apply to.</p>"
        },
        "Slots":{
          "shape":"String",
    ...
    "NodeGroupsPerReplicationGroupQuotaExceededFault":{
      ...
      "documentation":"<p>The request cannot be processed because it would exceed the maximum allowed number of node groups (shards) in a single replication group. The default maximum is 15</p>",
      "error":{
