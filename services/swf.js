  ...
  "shapes":{
    ...
    "ActivityTaskScheduledEventAttributes":{
      ...
      "members":{
        ...
        "taskPriority":{
          "shape":"TaskPriority",
          "documentation":"<p> The priority to assign to the scheduled activity task. If set, this overrides any default priority value that was assigned when the activity type was registered.</p> <p>Valid values are integers that range from Java's <code>Integer.MIN_VALUE</code> (-2147483648) to <code>Integer.MAX_VALUE</code> (2147483647). Higher numbers indicate higher priority.</p> <p>For more information about setting task priority, see <a href=\"http://docs.aws.amazon.com/amazonswf/latest/developerguide/programming-priority.html\">Setting Task Priority</a> in the <i>Amazon SWF Developer Guide</i>.</p>"
        },
        "decisionTaskCompletedEventId":{
          "shape":"EventId",
    ...
    "DecisionTaskScheduledEventAttributes":{
      ...
      "members":{
        ...
        "taskPriority":{
          "shape":"TaskPriority",
          "documentation":"<p> A task priority that, if set, specifies the priority for this decision task. Valid values are integers that range from Java's <code>Integer.MIN_VALUE</code> (-2147483648) to <code>Integer.MAX_VALUE</code> (2147483647). Higher numbers indicate higher priority.</p> <p>For more information about setting task priority, see <a href=\"http://docs.aws.amazon.com/amazonswf/latest/developerguide/programming-priority.html\">Setting Task Priority</a> in the <i>Amazon SWF Developer Guide</i>.</p>"
        },
        "startToCloseTimeout":{
          "shape":"DurationInSecondsOptional",
    ...
    "DomainAlreadyExistsFault":{
      ...
      "documentation":"<p>Returned if the specified domain already exists. You get this fault even if the existing domain is in deprecated status.</p>",
      "exception":true
    },
    "DomainConfiguration":{
      "type":"structure",
    ...
    "OperationNotPermittedFault":{
      ...
      "documentation":"<p>Returned when the caller doesn't have sufficient permissions to invoke the action.</p>",
      "exception":true
    },
    "PageSize":{
      "type":"integer",
    ...
    "RegisterActivityTypeInput":{
      ...
      "members":{
        ...
        "defaultTaskPriority":{
          "shape":"TaskPriority",
          "documentation":"<p>The default task priority to assign to the activity type. If not assigned, then <code>0</code> is used. Valid values are integers that range from Java's <code>Integer.MIN_VALUE</code> (-2147483648) to <code>Integer.MAX_VALUE</code> (2147483647). Higher numbers indicate higher priority.</p> <p>For more information about setting task priority, see <a href=\"http://docs.aws.amazon.com/amazonswf/latest/developerguide/programming-priority.html\">Setting Task Priority</a> in the <i>in the <i>Amazon SWF Developer Guide</i>.</i>.</p>"
        },
        "defaultTaskScheduleToStartTimeout":{
          "shape":"DurationInSecondsOptional",
    ...
    "RegisterWorkflowTypeInput":{
      ...
      "members":{
        ...
        "name":{
          "shape":"Name",
          "documentation":"<p>The name of the workflow type.</p> <p>The specified string must not start or end with whitespace. It must not contain a <code>:</code> (colon), <code>/</code> (slash), <code>|</code> (vertical bar), or any control characters (<code>\\u0000-\\u001f</code> | <code>\\u007f-\\u009f</code>). Also, it must not contain the literal string <code>arn</code>.</p>"
        },
        "version":{
          "shape":"Version",
        ...
        "defaultTaskPriority":{
          "shape":"TaskPriority",
          "documentation":"<p>The default task priority to assign to the workflow type. If not assigned, then <code>0</code> is used. Valid values are integers that range from Java's <code>Integer.MIN_VALUE</code> (-2147483648) to <code>Integer.MAX_VALUE</code> (2147483647). Higher numbers indicate higher priority.</p> <p>For more information about setting task priority, see <a href=\"http://docs.aws.amazon.com/amazonswf/latest/developerguide/programming-priority.html\">Setting Task Priority</a> in the <i>Amazon SWF Developer Guide</i>.</p>"
        },
        "defaultChildPolicy":{
          "shape":"ChildPolicy",
    ...
    "StartWorkflowExecutionInput":{
      ...
      "members":{
        ...
        "taskPriority":{
          "shape":"TaskPriority",
          "documentation":"<p>The task priority to use for this workflow execution. This overrides any default priority that was assigned when the workflow type was registered. If not set, then the default task priority for the workflow type is used. Valid values are integers that range from Java's <code>Integer.MIN_VALUE</code> (-2147483648) to <code>Integer.MAX_VALUE</code> (2147483647). Higher numbers indicate higher priority.</p> <p>For more information about setting task priority, see <a href=\"http://docs.aws.amazon.com/amazonswf/latest/developerguide/programming-priority.html\">Setting Task Priority</a> in the <i>Amazon SWF Developer Guide</i>.</p>"
        },
        "input":{
          "shape":"Data",
    ...
    "TagFilter":{
      ...
      "members":{
        "tag":{
          "shape":"Tag",
          "documentation":"<p> Specifies the tag that must be associated with the execution for it to meet the filter criteria.</p>"
        }
      },
    ...
    "TypeAlreadyExistsFault":{
      ...
      "documentation":"<p>Returned if the type already exists in the specified domain. You get this fault even if the existing type is in deprecated status. You can specify another version if the intent is to create a new distinct version of the type.</p>",
      "exception":true
    },
    "TypeDeprecatedFault":{
      "type":"structure",
