awsim['kinesisanalytics'] = {
  ...
  "operations":{
    ...
    "AddApplicationInputProcessingConfiguration":{
      ...
      "documentation":"<p>Adds an <a>InputProcessingConfiguration</a> to an application. An input processor preprocesses records on the input stream before the application's SQL code executes. Currently, the only input processor available is <a href=\"https://aws.amazon.com/documentation/lambda/\">AWS Lambda</a>.</p>"
    },
  ...
  "shapes":{
    ...
    "AddApplicationInputProcessingConfigurationRequest":{
      ...
      "members":{
        ...
        "CurrentApplicationVersionId":{
          "shape":"ApplicationVersionId",
          "documentation":"<p>Version of the application to which you want to add the input processing configuration. You can use the <a>DescribeApplication</a> operation to get the current application version. If the version specified is not the current version, the <code>ConcurrentModificationException</code> is returned.</p>"
        },
        "InputId":{
          "shape":"Id",
    ...
    "AddApplicationOutputRequest":{
      ...
      "members":{
        ...
        "CurrentApplicationVersionId":{
          "shape":"ApplicationVersionId",
          "documentation":"<p>Version of the application to which you want to add the output configuration. You can use the <a>DescribeApplication</a> operation to get the current application version. If the version specified is not the current version, the <code>ConcurrentModificationException</code> is returned. </p>"
        },
        "Output":{
          "shape":"Output",
    ...
    "DeleteApplicationCloudWatchLoggingOptionRequest":{
      ...
      "members":{
        ...
        "CloudWatchLoggingOptionId":{
          "shape":"Id",
          "documentation":"<p>The <code>CloudWatchLoggingOptionId</code> of the CloudWatch logging option to delete. You can get the <code>CloudWatchLoggingOptionId</code> by using the <a>DescribeApplication</a> operation. </p>"
        }
      }
    },
    ...
    "DiscoverInputSchemaRequest":{
      ...
      "members":{
        ...
        "S3Configuration":{
          ...
          "documentation":"<p>Specify this parameter to discover a schema from data in an S3 object.</p>"
        },
        "InputProcessingConfiguration":{
          "shape":"InputProcessingConfiguration",
    ...
    "Input":{
      ...
      "members":{
        ...
        "InputParallelism":{
          ...
          "documentation":"<p>Describes the number of in-application streams to create. </p> <p>Data from your source is routed to these in-application input streams.</p> <p> (see <a href=\"http://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html\">Configuring Application Input</a>.</p>"
        },
        "InputSchema":{
          "shape":"SourceSchema",
    ...
    "InputLambdaProcessor":{
      ...
      "members":{
        "ResourceARN":{
          "shape":"ResourceARN",
          "documentation":"<p>The ARN of the <a href=\"https://aws.amazon.com/documentation/lambda/\">AWS Lambda</a> function that operates on records in the stream.</p>"
        },
        "RoleARN":{
          "shape":"RoleARN",
      ...
      "documentation":"<p>An object that contains the Amazon Resource Name (ARN) of the <a href=\"https://aws.amazon.com/documentation/lambda/\">AWS Lambda</a> function that is used to preprocess records in the stream, and the ARN of the IAM role that is used to access the AWS Lambda function. </p>"
    },
    "InputLambdaProcessorDescription":{
      ...
      "members":{
        "ResourceARN":{
          "shape":"ResourceARN",
          "documentation":"<p>The ARN of the <a href=\"https://aws.amazon.com/documentation/lambda/\">AWS Lambda</a> function that is used to preprocess the records in the stream.</p>"
        },
        "RoleARN":{
          "shape":"RoleARN",
          "documentation":"<p>The ARN of the IAM role that is used to access the AWS Lambda function.</p>"
      ...
      "documentation":"<p>An object that contains the Amazon Resource Name (ARN) of the <a href=\"https://aws.amazon.com/documentation/lambda/\">AWS Lambda</a> function that is used to preprocess records in the stream, and the ARN of the IAM role that is used to access the AWS Lambda expression.</p>"
    },
    "InputLambdaProcessorUpdate":{
      ...
      "members":{
        "ResourceARNUpdate":{
          "shape":"ResourceARN",
          "documentation":"<p>The Amazon Resource Name (ARN) of the new <a href=\"https://aws.amazon.com/documentation/lambda/\">AWS Lambda</a> function that is used to preprocess the records in the stream.</p>"
        },
        "RoleARNUpdate":{
          "shape":"RoleARN",
      ...
      "documentation":"<p>Represents an update to the <a>InputLambdaProcessor</a> that is used to preprocess the records in the stream.</p>"
    },
    "InputParallelism":{
      "type":"structure",
      "members":{
      ...
      "documentation":"<p>Describes the number of in-application streams to create for a given streaming source. For information about parallelism, see <a href=\"http://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html\">Configuring Application Input</a>. </p>"
    },
    ...
    "InputProcessingConfiguration":{
      ...
      "documentation":"<p>Provides a description of a processor that is used to preprocess the records in the stream before being processed by your application code. Currently, the only input processor available is <a href=\"https://aws.amazon.com/documentation/lambda/\">AWS Lambda</a>.</p>"
    },
    "InputProcessingConfigurationDescription":{
      "type":"structure",
      "members":{
      ...
      "documentation":"<p>Provides configuration information about an input processor. Currently, the only input processor available is <a href=\"https://aws.amazon.com/documentation/lambda/\">AWS Lambda</a>.</p>"
    },
    ...
    "KinesisFirehoseInputUpdate":{
      ...
      "members":{
        ...
        "RoleARNUpdate":{
          "shape":"RoleARN",
          "documentation":"<p>ARN of the IAM role that Amazon Kinesis Analytics can assume to access the stream on your behalf. You need to grant necessary permissions to this role.</p>"
        }
      },
    ...
    "KinesisFirehoseOutputUpdate":{
      ...
      "documentation":"<p> When updating an output configuration using the <a>UpdateApplication</a> operation, provides information about an Amazon Kinesis Firehose delivery stream configured as the destination. </p>"
    },
    "KinesisStreamsInput":{
      "type":"structure",
      "required":[
    ...
    "KinesisStreamsOutputUpdate":{
      ...
      "documentation":"<p> When updating an output configuration using the <a>UpdateApplication</a> operation, provides information about an Amazon Kinesis stream configured as the destination. </p>"
    },
    "LambdaOutput":{
      "type":"structure",
      "required":[
      ...
      "members":{
        "ResourceARN":{
          "shape":"ResourceARN",
          "documentation":"<p>Amazon Resource Name (ARN) of the destination Lambda function to write to.</p>"
        },
        "RoleARN":{
          "shape":"RoleARN",
    ...
    "LambdaOutputUpdate":{
      ...
      "documentation":"<p>When updating an output configuration using the <a>UpdateApplication</a> operation, provides information about an AWS Lambda function configured as the destination.</p>"
    },
    "LimitExceededException":{
      ...
      "documentation":"<p>Exceeded the number of applications allowed.</p>",
      "exception":true
    },
    ...
    "RecordColumn":{
      ...
      "members":{
        ...
        "Mapping":{
          ...
          "documentation":"<p>Reference to the data element in the streaming input of the reference data source.</p>"
        },
        "SqlType":{
    ...
    "ReferenceDataSourceDescription":{
      ...
      "members":{
        "ReferenceId":{
          "shape":"Id",
          "documentation":"<p>ID of the reference data source. This is the ID that Amazon Kinesis Analytics assigns when you add the reference data source to your application using the <a>AddApplicationReferenceDataSource</a> operation.</p>"
        },
        "TableName":{
          "shape":"InAppTableName",
    ...
    "ReferenceDataSourceUpdate":{
      ...
      "members":{
        "ReferenceId":{
          "shape":"Id",
          "documentation":"<p>ID of the reference data source being updated. You can use the <a>DescribeApplication</a> operation to get this value.</p>"
        },
        "TableNameUpdate":{
          "shape":"InAppTableName",
    ...
    "ResourceInUseException":{
      ...
      "documentation":"<p>Application is not available for this operation.</p>",
      "exception":true
    },
    "ResourceNotFoundException":{
      ...
      "documentation":"<p>Specified application can't be found.</p>",
      "exception":true
    },
    ...
    "S3Configuration":{
      ...
      "documentation":"<p>Provides a description of an Amazon S3 data source, including the Amazon Resource Name (ARN) of the S3 bucket, the ARN of the IAM role that is used to access the bucket, and the name of the S3 object that contains the data.</p>"
    },
    "S3ReferenceDataSource":{
      "type":"structure",
      "required":[
    ...
    "UnableToDetectSchemaException":{
      ...
      "documentation":"<p>Data format is not valid, Amazon Kinesis Analytics is not able to detect schema for the given streaming source.</p>",
      "exception":true
    },
    "UpdateApplicationRequest":{
      ...
      "members":{
        ...
        "CurrentApplicationVersionId":{
          "shape":"ApplicationVersionId",
          "documentation":"<p>The current application version ID. You can use the <a>DescribeApplication</a> operation to get this value.</p>"
        },
        "ApplicationUpdate":{
