awsim['shield'] = {
  ...
  "operations":{
    "AssociateDRTLogBucket":{
      ...
      "documentation":"<p>Authorizes the DDoS Response team (DRT) to access the specified Amazon S3 bucket containing your flow logs. You can associate up to 10 Amazon S3 buckets with your subscription.</p> <p>To use the services of the DRT and make an <code>AssociateDRTLogBucket</code> request, you must be subscribed to the <a href=\"https://aws.amazon.com/premiumsupport/business-support/\">Business Support plan</a> or the <a href=\"https://aws.amazon.com/premiumsupport/enterprise-support/\">Enterprise Support plan</a>.</p>"
    },
    "AssociateDRTRole":{
    ...
    "CreateProtection":{
      ...
      "documentation":"<p>Enables AWS Shield Advanced for a specific AWS resource. The resource can be an Amazon CloudFront distribution, Elastic Load Balancing load balancer, Elastic IP Address, or an Amazon Route 53 hosted zone.</p> <p>You can add protection to only a single resource with each CreateProtection request. If you want to add protection to multiple resources at once, use the <a href=\"https://console.aws.amazon.com/waf/\">AWS WAF console</a>. For more information see <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/getting-started-ddos.html\">Getting Started with AWS Shield Advanced</a> and <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/configure-new-protection.html\">Add AWS Shield Advanced Protection to more AWS Resources</a>.</p>"
    },
    "CreateSubscription":{
  ...
  "shapes":{
    ...
    "AssociateDRTLogBucketRequest":{
      ...
      "members":{
        "LogBucket":{
          "shape":"LogBucket",
          "documentation":"<p>The Amazon S3 bucket that contains your flow logs.</p>"
        }
      }
    },
    ...
    "AttackProperty":{
      ...
      "members":{
        "AttackLayer":{
          "shape":"AttackLayer",
          "documentation":"<p>The type of DDoS event that was observed. <code>NETWORK</code> indicates layer 3 and layer 4 events and <code>APPLICATION</code> indicates layer 7 events.</p>"
        },
        "AttackPropertyIdentifier":{
          "shape":"AttackPropertyIdentifier",
          "documentation":"<p>Defines the DDoS attack property information that is provided.</p>"
        },
        "TopContributors":{
